...
cp /tmp/key/hive.service.keytab /etc/security/keytabs/
chown -R hive:hdpusers /etc/security/keytabs
chmod 750 /etc/security/keytabs
chmod 700 /etc/security/keytabs/hadoop.jks
chown hive:hdpusers /etc/security/keytabs/hadoop.jks

mkdir /home/hive
chown hive:hdpusers /home/hive
